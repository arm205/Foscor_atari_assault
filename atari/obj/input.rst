...
Hexadecimal [16-Bits]
   ...
   438A 01                   98 cmp_render: .db 0x01
                             99 ;; 00000010 para las entidades que usen IA
   438B 02                  100 cmp_ia: .db 0x02
                            101 ;; 00000100 para las entidades con input (player)
   438C 04                  102 cmp_input: .db 0x04
                            103 ;;  entidades con colisiones
   438D 08                  104 cmp_collider: .db 0x08
                            105 
                            106 
                            107 ;; Tipos de las entidades
   438E 00                  108 t_default: .db 0x00
                            109 
...
Hexadecimal [16-Bits]
   ...
   4390 C9            [10]    8 ret
                              9 
                             10 
   4391                      11 input_update::
   4391 57            [ 4]   12     ld d, a
   4392 3A 8C 43      [13]   13     ld a, (cmp_input)
   4395 CD E9 41      [17]   14     call E_M_for_all_matching
   4398 C9            [10]   15 ret
                             16 
                             17 
                             18 ;MODIFICA: AF, BC, DE, HL
   4399                      19 input_update_one::
   4399 DD 36 06 00   [19]   20     ld e_vx(ix), #0
                             21 
   439D DD 36 07 00   [19]   22     ld e_vy(ix), #0
                             23 
   43A1 CD A6 44      [17]   24     call cpct_scanKeyboard_f_asm
                             25 
   43A4 21 04 04      [10]   26     ld hl, #Key_O
   43A7 CD 9A 44      [17]   27     call cpct_isKeyPressed_asm
   43AA 28 04         [12]   28     jr z, O_NotPressed
   43AC                      29 O_Pressed:
   43AC DD 36 06 FF   [19]   30     ld e_vx(ix), #-1
   43B0                      31 O_NotPressed:
   43B0 21 03 08      [10]   32     ld hl, #Key_P
   43B3 CD 9A 44      [17]   33     call cpct_isKeyPressed_asm
   43B6 28 04         [12]   34     jr z, P_NotPressed
   43B8                      35 P_Pressed:
   43B8 DD 36 06 01   [19]   36     ld e_vx(ix), #1
   43BC                      37 P_NotPressed:
                             38 
   43BC 21 08 08      [10]   39     ld hl, #Key_Q
   43BF CD 9A 44      [17]   40     call cpct_isKeyPressed_asm
   43C2 28 04         [12]   41     jr z, Q_NotPressed
   43C4                      42 Q_Pressed:
   43C4 DD 36 07 FC   [19]   43     ld e_vy(ix), #-4
   43C8                      44 Q_NotPressed:
   43C8 21 08 20      [10]   45     ld hl, #Key_A
   43CB CD 9A 44      [17]   46     call cpct_isKeyPressed_asm
   43CE 28 04         [12]   47     jr z, A_NotPressed
   43D0                      48 A_Pressed:
   43D0 DD 36 07 04   [19]   49     ld e_vy(ix), #4
   43D4                      50 A_NotPressed:
                             51 
                             52 ;    ld e, e_t(ix)
                             53 ;    ld a, (t_bala)
                             54 ;    xor e
                             55 ;    jr nz, no_bala
                             56 ;
   43D4 21 05 80      [10]   57     ld hl, #Key_Space
   43D7 CD 9A 44      [17]   58     call cpct_isKeyPressed_asm
   43DA 28 05         [12]   59     jr z, Space_NotPressed
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 89.
Hexadecimal [16-Bits]



   43DC                      60 Space_Pressed:
   43DC DD 36 09 01   [19]   61     ld e_be(ix), #1
   43E0 C9            [10]   62     ret
                             63     
   43E1                      64 Space_NotPressed:
                             65 
   43E1 DD 36 09 00   [19]   66     ld e_be(ix), #0
                             67 
   43E5 C9            [10]   68 ret
                             69 

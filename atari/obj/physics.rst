...
Hexadecimal [16-Bits]
   ...
   43FF 01                  107 cmp_render: .db 0x01
                            108 ;; 00000010 para las entidades que usen IA
   4400 02                  109 cmp_ia: .db 0x02
...
Hexadecimal [16-Bits]
   ...
   4401 04                  111 cmp_input: .db 0x04
                            112 ;;  entidades con colisiones
   4402 08                  113 cmp_collider: .db 0x08
                            114 
                            115 
                            116 ;; Tipos de las entidades
   4403 00                  117 t_default: .db 0x00
                            118 
   4404 80                  119 t_dead: .db 0x80
                            120 
                            121 
                            122 
                            123 
...
Hexadecimal [16-Bits]
                              ...
                              3 
                              4 
                              5 .module entity_sys_physics
                              6 
                              7 
                     0050     8 screen_width = 80
                     00C8     9 screen_height = 200
                             10 
   4405                      11 physics_sys_init::
   4405 C9            [10]   12 ret
                             13 
   4406                      14 physics_sys_update::
   4406 57            [ 4]   15     ld d, a
   4407 3A FF 43      [13]   16     ld a, (cmp_render)
   440A CD E8 41      [17]   17     call E_M_for_all_matching
   440D C9            [10]   18 ret
                             19 
                             20 
                             21 ;
                             ...
                             25 ;
                             26 ;Modifica: CD, A
   440E                      27 physics_sys_for_one::
   440E 3E 50         [ 7]   28     ld a, #screen_width
   4410 DD 96 04      [19]   29     sub e_w(ix)
   4413 4F            [ 4]   30     ld  c, a
                             31 
   4414 DD 7E 02      [19]   32     ld a, e_x(ix)
   4417 DD 86 06      [19]   33     add e_vx(ix)
   441A B9            [ 4]   34     cp  c
   441B 30 05         [12]   35     jr nc, invalid_x
                             36 
   441D                      37     id_x:
   441D DD 77 02      [19]   38         ld e_x(ix), a
   4420 18 00         [12]   39         jr  endif_x
   4422                      40     invalid_x:
   4422                      41 endif_x:
                             42 
   4422 3E C8         [ 7]   43     ld a, #screen_height
   4424 DD 96 05      [19]   44     sub e_h(ix)
   4427 4F            [ 4]   45     ld  c, a
                             46 
   4428 DD 7E 03      [19]   47     ld a, e_y(ix)
   442B DD 86 07      [19]   48     add e_vy(ix)
   442E B9            [ 4]   49     cp  c
   442F 30 05         [12]   50     jr nc, invalid_y
                             51 
   4431                      52     id_y:
   4431 DD 77 03      [19]   53         ld e_y(ix), a
   4434 18 08         [12]   54         jr  endif_y
   4436                      55     invalid_y:
   4436 DD 7E 07      [19]   56         ld  a, e_vy(ix)
   4439 ED 44         [ 8]   57         neg
...
Hexadecimal [16-Bits]
   ...
   443B DD 77 07      [19]   58         ld  e_vy(ix), a
   443E                      59 endif_y:
                             60 
                             61 
                             62 

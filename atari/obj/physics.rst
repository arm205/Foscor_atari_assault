...
Hexadecimal [16-Bits]
   ...
   43FD 01                   98 cmp_render: .db 0x01
                             99 ;; 00000010 para las entidades que usen IA
   43FE 02                  100 cmp_ia: .db 0x02
                            101 ;; 00000100 para las entidades con input (player)
   43FF 04                  102 cmp_input: .db 0x04
                            103 ;;  entidades con colisiones
   4400 08                  104 cmp_collider: .db 0x08
                            105 
                            106 
                            107 ;; Tipos de las entidades
   4401 00                  108 t_default: .db 0x00
                            109 
...
Hexadecimal [16-Bits]
                     ...
                     00C8     9 screen_height = 200
                             10 
   4403                      11 physics_sys_init::
   4403 C9            [10]   12 ret
                             13 
   4404                      14 physics_sys_update::
   4404 57            [ 4]   15     ld d, a
   4405 3A FD 43      [13]   16     ld a, (cmp_render)
   4408 CD E9 41      [17]   17     call E_M_for_all_matching
   440B C9            [10]   18 ret
                             19 
                             20 
                             21 ;
                             ...
                             25 ;
                             26 ;Modifica: CD, A
   440C                      27 physics_sys_for_one::
   440C 3E 50         [ 7]   28     ld a, #screen_width
   440E DD 96 04      [19]   29     sub e_w(ix)
   4411 4F            [ 4]   30     ld  c, a
                             31 
   4412 DD 7E 02      [19]   32     ld a, e_x(ix)
   4415 DD 86 06      [19]   33     add e_vx(ix)
   4418 B9            [ 4]   34     cp  c
   4419 30 05         [12]   35     jr nc, invalid_x
                             36 
   441B                      37     id_x:
   441B DD 77 02      [19]   38         ld e_x(ix), a
   441E 18 00         [12]   39         jr  endif_x
   4420                      40     invalid_x:
   4420                      41 endif_x:
                             42 
   4420 3E C8         [ 7]   43     ld a, #screen_height
   4422 DD 96 05      [19]   44     sub e_h(ix)
   4425 4F            [ 4]   45     ld  c, a
                             46 
   4426 DD 7E 03      [19]   47     ld a, e_y(ix)
   4429 DD 86 07      [19]   48     add e_vy(ix)
   442C B9            [ 4]   49     cp  c
   442D 30 05         [12]   50     jr nc, invalid_y
                             51 
   442F                      52     id_y:
   442F DD 77 03      [19]   53         ld e_y(ix), a
   4432 18 08         [12]   54         jr  endif_y
   4434                      55     invalid_y:
   4434 DD 7E 07      [19]   56         ld  a, e_vy(ix)
   4437 ED 44         [ 8]   57         neg
...
Hexadecimal [16-Bits]
   ...
   4439 DD 77 07      [19]   58         ld  e_vy(ix), a
   443C                      59 endif_y:
                             60 
                             61 
                             62 

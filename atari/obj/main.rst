...
Hexadecimal [16-Bits]
   ...
   43E6 01                   98 cmp_render: .db 0x01
                             99 ;; 00000010 para las entidades que usen IA
   43E7 02                  100 cmp_ia: .db 0x02
                            101 ;; 00000100 para las entidades con input (player)
   43E8 04                  102 cmp_input: .db 0x04
                            103 ;;  entidades con colisiones
   43E9 08                  104 cmp_collider: .db 0x08
                            105 
                            106 
                            107 ;; Tipos de las entidades
   43EA 00                  108 t_default: .db 0x00
                            109 
...
Hexadecimal [16-Bits]
                             ...
                             12 
   43EC                      13 _main::
   43EC CD B9 45      [17]   14    call cpct_disableFirmware_asm
   43EF CD E8 42      [17]   15    call man_game_init
                             16 
   43F2                      17 loop:
                             18 ;   call esperar
   43F2 CD 11 43      [17]   19    call man_game_update
                             20 
   43F5 CD B1 45      [17]   21    call cpct_waitVSYNC_asm
   43F8 CD 2A 43      [17]   22    call man_game_render
                             23 
   43FB 18 F5         [12]   24    jr    loop
                             25 

...
Hexadecimal [16-Bits]
   ...
   42A0 01                   98 cmp_render: .db 0x01
                             99 ;; 00000010 para las entidades que usen IA
   42A1 02                  100 cmp_ia: .db 0x02
                            101 ;; 00000100 para las entidades con input (player)
   42A2 04                  102 cmp_input: .db 0x04
                            103 ;;  entidades con colisiones
   42A3 08                  104 cmp_collider: .db 0x08
                            105 
                            106 
                            107 ;; Tipos de las entidades
   42A4 00                  108 t_default: .db 0x00
                            109 
...
Hexadecimal [16-Bits]
                              ...
                              8 .include "collider.h.s"
                              1 .globl collider_one_pair
                              2 .globl collider_update
                              3 
                              4 
   42A6 00                    5 x_ban: .db 0x00
   42A7 00                    6 y_ban: .db 0x00
                              7 
                              8 
                              9 
   42A8 00                   10 x_ban_2: .db 0x00
   42A9 00                   11 y_ban_2: .db 0x00
...
Hexadecimal [16-Bits]
                             ...
                             10 
                             11 
   42AA                      12 DefineEnemyEntity enemy, 20, 20, 4, 8, -1, 0, 0xFF, 1
   000A                       1 enemy::
   42AA 02                    2     t_enemy:: .db 0x02 ;    type of entity is enemy
   42AB 0B                    3     cmp_enemy:: .db 0x0B   ;components that enemy has
   000C                       4     CommonDefine 20, 20, 4, 8, -1, 0, 0xFF, 1
   42AC 14                    1     .db 20 ;    position x of entity
   42AD 14                    2     .db 20 ;    position y of entity
   42AE 04                    3     .db 4 ;    width of entity
   42AF 08                    4     .db 8 ;    height y of entity
   42B0 FF                    5     .db -1 ;    speed x of entity
   42B1 00                    6     .db 0 ;    speed x of entity
   42B2 FF                    7     .db 0xFF ;    color of entity
   42B3 01                    8     .db 1;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   42B4 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   42B6 00                    5     enemy_col:: .db 0x00
                             13 
   42B7                      14 DefineEnemy2Entity enemy2, 20, 40, 4, 8, -1, 0, 0xFF, 1
   0017                       1 enemy2::
   42B7 02                    2     .db 0x02 ;    type of entity is enemy
   42B8 0B                    3     .db 0x0B    ;components that enemy has
   0019                       4     CommonDefine 20, 40, 4, 8, -1, 0, 0xFF, 1
   42B9 14                    1     .db 20 ;    position x of entity
   42BA 28                    2     .db 40 ;    position y of entity
   42BB 04                    3     .db 4 ;    width of entity
   42BC 08                    4     .db 8 ;    height y of entity
   42BD FF                    5     .db -1 ;    speed x of entity
   42BE 00                    6     .db 0 ;    speed x of entity
   42BF FF                    7     .db 0xFF ;    color of entity
   42C0 01                    8     .db 1;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   42C1 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   42C3 00                    5     .db 0x00
                             15 
   42C4                      16 DefinePlayerEntity player, 20, 180, 2, 8, -1, 0, 0x0F, 0
   0024                       1 player::
   42C4 01                    2     t_player:: .db  0x01;    type of entity is player
   42C5 0D                    3     cmp_player:: .db 0x0D   ;components that player has
   0026                       4     CommonDefine 20, 180, 2, 8, -1, 0, 0x0F, 0
   42C6 14                    1     .db 20 ;    position x of entity
   42C7 B4                    2     .db 180 ;    position y of entity
   42C8 02                    3     .db 2 ;    width of entity
   42C9 08                    4     .db 8 ;    height y of entity
   42CA FF                    5     .db -1 ;    speed x of entity
   42CB 00                    6     .db 0 ;    speed x of entity
   42CC 0F                    7     .db 0x0F ;    color of entity
   42CD 00                    8     .db 0;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   42CE CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   42D0 06                    5     player_col:: .db 0x06
                             17 
                             18 
   42D1                      19 DefineCajaEntity caja, 50, 110, 2, 8, 0, 0, 0xF0, 0
   0031                       1 caja::
   42D1 04                    2     t_caja:: .db 0x04 ;    type of entity is breakable box
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 93.
Hexadecimal [16-Bits]



   42D2 09                    3     cmp_caja:: .db 0x09   ;components that box has
   0033                       4     CommonDefine 50, 110, 2, 8, 0, 0, 0xF0, 0
   42D3 32                    1     .db 50 ;    position x of entity
   42D4 6E                    2     .db 110 ;    position y of entity
   42D5 02                    3     .db 2 ;    width of entity
   42D6 08                    4     .db 8 ;    height y of entity
   42D7 00                    5     .db 0 ;    speed x of entity
   42D8 00                    6     .db 0 ;    speed x of entity
   42D9 F0                    7     .db 0xF0 ;    color of entity
   42DA 00                    8     .db 0;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   42DB CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   42DD 01                    5     caja_col:: .db 0x01
                             20 
                             21 
                             22 
   42DE 47 41 4D 45 20 4F    23 final_text: .asciz "GAME OVER"
        56 45 52 00
                             24 
                             25 
   42E8                      26 man_game_init::
   42E8 CD B9 41      [17]   27     call E_M_init
                             28 
   42EB CD 7B 44      [17]   29     call _render_sys_init
   42EE CD 03 44      [17]   30     call physics_sys_init
   42F1 CD 90 43      [17]   31     call input_init
                             32 
   42F4 21 AA 42      [10]   33     ld hl, #enemy
   42F7 CD 0D 43      [17]   34     call man_game_entity_creator
                             35 
                             36 
   42FA 21 B7 42      [10]   37     ld hl, #enemy2
   42FD CD 0D 43      [17]   38     call man_game_entity_creator
                             39 
                             40 
                             41 
   4300 21 D1 42      [10]   42     ld hl, #caja
   4303 CD 0D 43      [17]   43     call man_game_entity_creator
                             44 
   4306 21 C4 42      [10]   45     ld hl, #player
   4309 CD 0D 43      [17]   46     call man_game_entity_creator
                             47 
                             48 
                             49 
   430C C9            [10]   50 ret
                             51 
                             52 ;;INPUT:HL: Puntero al tipo de entidad que se quiera crear
                             53 
   430D                      54 man_game_entity_creator::
   430D CD D5 41      [17]   55     call E_M_create
   4310 C9            [10]   56 ret
   4311                      57 man_game_update::
                             58  
                             59    ;; Init system
   4311 CD E1 41      [17]   60     call E_M_getEntityArray
   4314 CD 91 43      [17]   61     call input_update
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 94.
Hexadecimal [16-Bits]



   4317 CD E1 41      [17]   62     call E_M_getEntityArray
   431A CD 82 43      [17]   63     call ia_update
   431D CD E1 41      [17]   64     call E_M_getEntityArray
   4320 CD 0E 40      [17]   65     call collider_update
   4323 CD E1 41      [17]   66     call E_M_getEntityArray
   4326 CD 04 44      [17]   67     call physics_sys_update
   4329 C9            [10]   68    ret
   432A                      69 man_game_render::
   432A CD E1 41      [17]   70     call E_M_getEntityArray
   432D CD 85 44      [17]   71     call _render_ents_update
   4330 C9            [10]   72 ret
                             73 
   4331                      74 man_game_end::
   4331 CD B9 41      [17]   75 call E_M_init
   0094                      76 cpctm_clearScreen_asm #0
   4334 21 00 C0      [10]    1    ld    hl, #0xC000    ;; [3] HL Points to Start of Video Memory
   4337 11 01 C0      [10]    2    ld    de, #0xC001    ;; [3] DE Points to the next byte
   433A 01 00 40      [10]    3    ld    bc, #0x4000    ;; [3] BC = 16384 bytes to be copied
   433D 36 00         [10]    4    ld   (hl), ##0      ;; [3] First Byte = given Colour
   433F ED B0         [21]    5    ldir                 ;; [98297] Perform the copy
                             77 
   4341 11 00 C0      [10]   78 ld de, #0xC000
   4344 0E 14         [ 7]   79 ld c, #20
   4346 06 5C         [ 7]   80 ld b, #92
   4348 CD 92 46      [17]   81 call cpct_getScreenPtr_asm
   434B FD 21 DE 42   [14]   82 ld iy, #final_text
   434F CD 10 45      [17]   83 call cpct_drawStringM0_asm
                             84 
   4352 18 FE         [12]   85 jr .
                             86 

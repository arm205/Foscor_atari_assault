...
Hexadecimal [16-Bits]
   ...
   42BC 01                  107 cmp_render: .db 0x01
                            108 ;; 00000010 para las entidades que usen IA
   42BD 02                  109 cmp_ia: .db 0x02
...
Hexadecimal [16-Bits]
   ...
   42BE 04                  111 cmp_input: .db 0x04
                            112 ;;  entidades con colisiones
   42BF 08                  113 cmp_collider: .db 0x08
                            114 
                            115 
                            116 ;; Tipos de las entidades
   42C0 00                  117 t_default: .db 0x00
                            118 
   42C1 80                  119 t_dead: .db 0x80
                            120 
                            121 
                            122 
                            123 
...
Hexadecimal [16-Bits]
                              ...
                              3 
                              4 
   42C2 00                    5 x_ban: .db 0x00
   42C3 00                    6 y_ban: .db 0x00
                              7 
                              8 
                              9 
   42C4 00                   10 x_ban_2: .db 0x00
   42C5 00                   11 y_ban_2: .db 0x00
...
Hexadecimal [16-Bits]
                             ...
                             13 
   42C6                      14 DefineEnemyEntity enemy, 70, 180, 4, 8, -1, 0, 0xFF, 1
   000A                       1 enemy::
   42C6 02                    2     t_enemy:: .db 0x02 ;    type of entity is enemy
   42C7 0B                    3     cmp_enemy:: .db 0x0B   ;components that enemy has
   000C                       4     CommonDefine 70, 180, 4, 8, -1, 0, 0xFF, 1
   42C8 46                    1     .db 70 ;    position x of entity
   42C9 B4                    2     .db 180 ;    position y of entity
   42CA 04                    3     .db 4 ;    width of entity
   42CB 08                    4     .db 8 ;    height y of entity
   42CC FF                    5     .db -1 ;    speed x of entity
   42CD 00                    6     .db 0 ;    speed x of entity
   42CE FF                    7     .db 0xFF ;    color of entity
   42CF 01                    8     .db 1;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   42D0 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   42D2 00                    5     enemy_col:: .db 0x00
                             15 
   42D3                      16 DefineEnemy2Entity enemy2, 0, 180, 4, 8, -1, 0, 0xFF, 0
   0017                       1 enemy2::
   42D3 02                    2     .db 0x02 ;    type of entity is enemy
   42D4 0B                    3     .db 0x0B    ;components that enemy has
   0019                       4     CommonDefine 0, 180, 4, 8, -1, 0, 0xFF, 0
   42D5 00                    1     .db 0 ;    position x of entity
   42D6 B4                    2     .db 180 ;    position y of entity
   42D7 04                    3     .db 4 ;    width of entity
   42D8 08                    4     .db 8 ;    height y of entity
   42D9 FF                    5     .db -1 ;    speed x of entity
   42DA 00                    6     .db 0 ;    speed x of entity
   42DB FF                    7     .db 0xFF ;    color of entity
   42DC 00                    8     .db 0;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   42DD CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   42DF 00                    5     .db 0x00
                             17 
                             18 ;DefineEnemy2Entity enemy2, 0, 180, 4, 8, -1, 0, 0xFF, 2
                             19 
   42E0                      20 DefinePlayerEntity player, 20, 180, 4, 16, -1, 0, 0x0F, 0
   0024                       1 player::
   42E0 01                    2     t_player:: .db  0x01;    type of entity is player
   42E1 0D                    3     cmp_player:: .db 0x0D   ;components that player has
   0026                       4     CommonDefine 20, 180, 4, 16, -1, 0, 0x0F, 0
   42E2 14                    1     .db 20 ;    position x of entity
   42E3 B4                    2     .db 180 ;    position y of entity
   42E4 04                    3     .db 4 ;    width of entity
   42E5 10                    4     .db 16 ;    height y of entity
   42E6 FF                    5     .db -1 ;    speed x of entity
   42E7 00                    6     .db 0 ;    speed x of entity
   42E8 0F                    7     .db 0x0F ;    color of entity
   42E9 00                    8     .db 0;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   42EA CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   42EC 06                    5     player_col:: .db 0x06
                             21 
...
Hexadecimal [16-Bits]
   ...
   42ED                      22 DefineCajaEntity caja, 40, 100, 2, 8, 0, 0, 0xF0, 0
   0031                       1 caja::
   42ED 04                    2     t_caja:: .db 0x04 ;    type of entity is breakable box
   42EE 09                    3     cmp_caja:: .db 0x09   ;components that box has
   0033                       4     CommonDefine 40, 100, 2, 8, 0, 0, 0xF0, 0
   42EF 28                    1     .db 40 ;    position x of entity
   42F0 64                    2     .db 100 ;    position y of entity
   42F1 02                    3     .db 2 ;    width of entity
   42F2 08                    4     .db 8 ;    height y of entity
   42F3 00                    5     .db 0 ;    speed x of entity
   42F4 00                    6     .db 0 ;    speed x of entity
   42F5 F0                    7     .db 0xF0 ;    color of entity
   42F6 00                    8     .db 0;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   42F7 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   42F9 01                    5     caja_col:: .db 0x01
                             23 
                             24 ;DefineBalaEntity bala, 20, 180, 2, 8, 0, 0, 0xF0, 0, 2
   42FA 47 41 4D 45 20 4F    25 final_text: .asciz "GAME OVER"
        56 45 52 00
                             26 
                             27 
   ...
   4313 CD 29 43      [17]   36     call man_game_entity_creator
   4316 21 D3 42      [10]   37     ld hl, #enemy2
   4319 CD 29 43      [17]   38     call man_game_entity_creator
                             39 ;    ld hl, #enemy2
                             40 ;    call man_game_entity_creator
   431C 21 ED 42      [10]   41     ld hl, #caja
                             42 ;    call man_game_entity_creator
                             43 ;    ld hl, #bala
   431F CD 29 43      [17]   44     call man_game_entity_creator
   4322 21 E0 42      [10]   45     ld hl, #player
   4325 CD 29 43      [17]   46     call man_game_entity_creator
                             47 
                             48 
                             49 
   4328 C9            [10]   50 ret
                             ...
                             53 
   4329                      54 man_game_entity_creator::
   4329 CD EB 41      [17]   55     call E_M_create
   432C C9            [10]   56 ret
                             57 
                             58 
                             59 
...
Hexadecimal [16-Bits]
                             ...
                             62 
   432D                      63 man_game_update::
                             64  
                             65    ;; Init system
   432D CD F7 41      [17]   66     call E_M_getEntityArray
   4330 CD BA 43      [17]   67    call input_update
   4333 CD F7 41      [17]   68     call E_M_getEntityArray
   4336 CD A9 43      [17]   69    call ia_update
   ...
   434D CD CF 41      [17]   84 call E_M_init
   0094                      85 cpctm_clearScreen_asm #0
   4350 21 00 C0      [10]    1    ld    hl, #0xC000    ;; [3] HL Points to Start of Video Memory
   4353 11 01 C0      [10]    2    ld    de, #0xC001    ;; [3] DE Points to the next byte
   4356 01 00 40      [10]    3    ld    bc, #0x4000    ;; [3] BC = 16384 bytes to be copied
   4359 36 00         [10]    4    ld   (hl), ##0      ;; [3] First Byte = given Colour
   435B ED B0         [21]    5    ldir                 ;; [98297] Perform the copy
                             86 

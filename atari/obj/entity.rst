...
Hexadecimal [16-Bits]
                              ...
                              8 .globl _cpct_getRandom_mxor_u8
...
Hexadecimal [16-Bits]
   ...
   415E 01                   98 cmp_render: .db 0x01
                             99 ;; 00000010 para las entidades que usen IA
   415F 02                  100 cmp_ia: .db 0x02
                            101 ;; 00000100 para las entidades con input (player)
   4160 04                  102 cmp_input: .db 0x04
                            103 ;;  entidades con colisiones
   4161 08                  104 cmp_collider: .db 0x08
                            105 
                            106 
                            107 ;; Tipos de las entidades
   4162 00                  108 t_default: .db 0x00
                            109 
...
Hexadecimal [16-Bits]
                             ...
                             11 .include "collider.h.s"
                              1 .globl collider_one_pair
                              2 .globl collider_update
                              3 
                              4 
   4164 00                    5 x_ban: .db 0x00
   4165 00                    6 y_ban: .db 0x00
                              7 
                              8 
                              9 
   4166 00                   10 x_ban_2: .db 0x00
   4167 00                   11 y_ban_2: .db 0x00
...
Hexadecimal [16-Bits]
                             ...
                             12 
                     0006    13 max_entities == 6
                             14 
   4168 00                   15 _num_entities:: .db 0
   4169 6B 41                16 _last_elem_ptr:: .dw _entity_array
   416B                      17 DefineEntityArray _entity_array, max_entities
   000D                       1 _entity_array::
                              2     .rept max_entities
                              3         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
                              4     .endm
   000D                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   416B 00                    1     .db 0x00 ;    type of entity default
   416C 00                    2     .db 0x00 ;      components of entity default
   000F                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   416D DE                    1     .db 0xDE ;    position x of entity
   416E AD                    2     .db 0xAD ;    position y of entity
   416F DE                    3     .db 0xDE ;    width of entity
   4170 AD                    4     .db 0xAD ;    height y of entity
   4171 DE                    5     .db 0xDE ;    speed x of entity
   4172 AD                    6     .db 0xAD ;    speed x of entity
   4173 DE                    7     .db 0xDE ;    color of entity
   4174 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   4175 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   4177 00                    4     .db 0x00
   001A                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4178 00                    1     .db 0x00 ;    type of entity default
   4179 00                    2     .db 0x00 ;      components of entity default
   001C                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   417A DE                    1     .db 0xDE ;    position x of entity
   417B AD                    2     .db 0xAD ;    position y of entity
   417C DE                    3     .db 0xDE ;    width of entity
   417D AD                    4     .db 0xAD ;    height y of entity
   417E DE                    5     .db 0xDE ;    speed x of entity
   417F AD                    6     .db 0xAD ;    speed x of entity
   4180 DE                    7     .db 0xDE ;    color of entity
   4181 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   4182 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   4184 00                    4     .db 0x00
   0027                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4185 00                    1     .db 0x00 ;    type of entity default
   4186 00                    2     .db 0x00 ;      components of entity default
   0029                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4187 DE                    1     .db 0xDE ;    position x of entity
   4188 AD                    2     .db 0xAD ;    position y of entity
   4189 DE                    3     .db 0xDE ;    width of entity
   418A AD                    4     .db 0xAD ;    height y of entity
   418B DE                    5     .db 0xDE ;    speed x of entity
   418C AD                    6     .db 0xAD ;    speed x of entity
   418D DE                    7     .db 0xDE ;    color of entity
   418E AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   418F CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   4191 00                    4     .db 0x00
   0034                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4192 00                    1     .db 0x00 ;    type of entity default
   4193 00                    2     .db 0x00 ;      components of entity default
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 94.
Hexadecimal [16-Bits]



   0036                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4194 DE                    1     .db 0xDE ;    position x of entity
   4195 AD                    2     .db 0xAD ;    position y of entity
   4196 DE                    3     .db 0xDE ;    width of entity
   4197 AD                    4     .db 0xAD ;    height y of entity
   4198 DE                    5     .db 0xDE ;    speed x of entity
   4199 AD                    6     .db 0xAD ;    speed x of entity
   419A DE                    7     .db 0xDE ;    color of entity
   419B AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   419C CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   419E 00                    4     .db 0x00
   0041                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   419F 00                    1     .db 0x00 ;    type of entity default
   41A0 00                    2     .db 0x00 ;      components of entity default
   0043                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41A1 DE                    1     .db 0xDE ;    position x of entity
   41A2 AD                    2     .db 0xAD ;    position y of entity
   41A3 DE                    3     .db 0xDE ;    width of entity
   41A4 AD                    4     .db 0xAD ;    height y of entity
   41A5 DE                    5     .db 0xDE ;    speed x of entity
   41A6 AD                    6     .db 0xAD ;    speed x of entity
   41A7 DE                    7     .db 0xDE ;    color of entity
   41A8 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   41A9 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   41AB 00                    4     .db 0x00
   004E                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41AC 00                    1     .db 0x00 ;    type of entity default
   41AD 00                    2     .db 0x00 ;      components of entity default
   0050                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41AE DE                    1     .db 0xDE ;    position x of entity
   41AF AD                    2     .db 0xAD ;    position y of entity
   41B0 DE                    3     .db 0xDE ;    width of entity
   41B1 AD                    4     .db 0xAD ;    height y of entity
   41B2 DE                    5     .db 0xDE ;    speed x of entity
   41B3 AD                    6     .db 0xAD ;    speed x of entity
   41B4 DE                    7     .db 0xDE ;    color of entity
   41B5 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   41B6 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   41B8 00                    4     .db 0x00
                             18 
                             19 ; Input
                             20 ; Desc: Pone a 0 el numero de entidades e inicializa el array de entidades
                             21 ; Modifies: A, HL
   41B9                      22 E_M_init::
   41B9 AF            [ 4]   23     xor a
   41BA 32 68 41      [13]   24     ld (_num_entities), a
                             25 
   41BD 21 6B 41      [10]   26     ld hl, #_entity_array
   41C0 22 69 41      [16]   27     ld (_last_elem_ptr), hl
   41C3 C9            [10]   28 ret
                             29 
                             30 
                             31 ; Input
...
Hexadecimal [16-Bits]
   ...
   41C4                      34 E_M_new::
                             35 ;   Increment number of reserved entities
   41C4 21 68 41      [10]   36     ld hl, #_num_entities
   41C7 34            [11]   37     inc (hl)
                             38 
                             39 ;   Increment Array end pointer to point to the next
                             40 ;   free element in the array
   41C8 2A 69 41      [16]   41     ld hl, (_last_elem_ptr)
   41CB 54            [ 4]   42     ld d, h
   41CC 5D            [ 4]   43     ld e, l
   41CD 01 0D 00      [10]   44     ld bc, #sizeof_e
   41D0 09            [11]   45     add hl, bc
   41D1 22 69 41      [16]   46     ld (_last_elem_ptr), hl
                             47 
   41D4 C9            [10]   48 ret
                             49 
                             50 ; Input: HL; pointer to entity initializer bytes, DE; Puntero a la direccion en la que se almacenara nueva entidad
                             51 ; Desc: Almacenamos la direccion de nueva entidad en IX y cargamos la uneva entidad con los valores almacenados en HL
                             52 ; Modifies: IX, HL, BC, DE
   41D5                      53 E_M_create::
   41D5 E5            [11]   54     push hl
                             55     
   41D6 CD C4 41      [17]   56     call E_M_new
                             57 
   007B                      58     ld__ixh_d
   41D9 DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
   007D                      59     ld__ixl_e
   41DB DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                             60 
                             61 
   41DD E1            [10]   62     pop hl
   41DE ED B0         [21]   63     ldir
                             64 
   41E0 C9            [10]   65 ret
                             66 
                             67 
                             68 
                             69 
                             70 ; Desc: Cargamos el numero de entidades que tengo en A y funtero al inicio del array en IX
                             71 ; Modifies: IX, A
   41E1                      72 E_M_getEntityArray::
   41E1 DD 21 6B 41   [14]   73     ld ix, #_entity_array
   41E5 3A 68 41      [13]   74     ld a, (_num_entities)
   41E8 C9            [10]   75 ret
                             76 
                             77 
                             78 
                             79 ;
                             80 ;Input: A; type that we are looking for, D; num entity
                             81 ;Desc: Buscamos todas las entidades validas cuyo tipo tenga el componente del signature(D en la amyoria del codigo) y se devuelve al sistema que lo ha llamado
                             82 ;Modifies: IX, BC, DE, A
   41E9                      83 E_M_for_all_matching::
   41E9 4F            [ 4]   84     ld c, a
   41EA 7A            [ 4]   85     ld a, d
   41EB 51            [ 4]   86     ld d, c
...
Hexadecimal [16-Bits]
                             ...
                             87 
                             88     ;intercambio A y D
                             89 
   41EC                      90 _renloop:
   41EC 32 2F 42      [13]   91     ld (_ent_counter), a
                             92 
   41EF DD 7E 00      [19]   93     ld a, e_t(ix)
   41F2 4F            [ 4]   94     ld c, a
   41F3 7B            [ 4]   95     ld a, e
   41F4 59            [ 4]   96     ld e, c
   41F5 3A 62 41      [13]   97     ld a, (t_default)
   41F8 A3            [ 4]   98     and e
   41F9 20 3A         [12]   99     jr nz, invalid_entity
                            100 
                            101     ;; erase previous istance
                            102 ; para mover todo lo que tenga a 1 el bit de ia
   41FB DD 7E 01      [19]  103     ld a, e_cmp(ix)
   41FE A2            [ 4]  104     and d
   41FF 20 02         [12]  105     jr nz, cumple
   4201 18 2B         [12]  106     jr continua
   4203                     107     cumple:    
   4203 3A 5F 41      [13]  108         ld a, (cmp_ia)
   4206 AA            [ 4]  109         xor d
   4207 28 02         [12]  110         jr z, con_ia
   4209 18 05         [12]  111         jr no_ia
   420B                     112         con_ia:
   420B CD 5A 43      [17]  113             call ia_update_one_entity
   420E 18 1E         [12]  114             jr continua
                            115 
   4210                     116         no_ia:
   4210 3A 60 41      [13]  117             ld a, (cmp_input)
   4213 AA            [ 4]  118             xor d
   4214 28 02         [12]  119             jr z, control
   4216 18 07         [12]  120             jr mover_cosas
   4218                     121                 control:
   4218 D5            [11]  122                 push de
                            123 ;; Con esto modifico la velocidad del player dependiendo de la tecla pulsada
   4219 CD 99 43      [17]  124                 call input_update_one
   421C D1            [10]  125                 pop de
   421D 18 0F         [12]  126                 jr continua
   421F                     127         mover_cosas:
   421F 3A 5E 41      [13]  128             ld a, (cmp_render)
   4222 AA            [ 4]  129             xor d
   4223 28 02         [12]  130             jr z, render
   4225 18 07         [12]  131             jr continua
   4227                     132                 render:
   4227 D5            [11]  133                 push de
                            134 ;; Llamo a que modifiquen la posicion todos los elementos que tengan el bit de render
   4228 CD 0C 44      [17]  135                 call physics_sys_for_one
   422B D1            [10]  136                 pop de
   422C 18 00         [12]  137                 jr continua
                            138             
   422E                     139     continua:
                            140 
                     00D1   141 _ent_counter = .+1
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 97.
Hexadecimal [16-Bits]



   422E 3E 00         [ 7]  142     ld  a, #0
   4230 3D            [ 4]  143     dec a
   4231 C8            [11]  144     ret z
                            145 
                            146 
                            147 
   4232 32 2F 42      [13]  148     ld (_ent_counter), a
                            149 
   4235                     150     invalid_entity:
   4235 01 0D 00      [10]  151     ld bc, #sizeof_e
   4238 DD 09         [15]  152     add ix, bc
   423A 18 B0         [12]  153     jr _renloop
                            154 
                            155 
                            156 ;;INPUT
                            157 ;;  A: Bit de signo (Si algo es colisionable)
                            158 ;;  D: Numero de entidades
                            159 
   423C                     160 E_M_for_all_pairs_matching::
                            161     ;Intercambio A y D;
   423C 4F            [ 4]  162     ld c, a
   423D 7A            [ 4]  163     ld a, d
   423E 51            [ 4]  164     ld d, c
                            165 
   423F                     166     _renloop_pairs:
                            167         ;;SE CARGA A CANTIDAD DE ENTIDADES
   423F 32 93 42      [13]  168         ld (_ent_counter2), a
                            169 
                            170         ;;VERIFICAR SI LA ENTIDAD EN IX ES DEFAULT
   4242 DD 5E 00      [19]  171         ld e, e_t(ix)
   4245 3A 62 41      [13]  172         ld a, (t_default)
   4248 A3            [ 4]  173         and e                           
                            174 
                            175         ;;CASO: ENTIDAD IX ES INVALIDA
   4249 20 4E         [12]  176         jr nz, invalid_entity_pairs
                            177 
                            178         ;;CASO: ENTIDAD IX ES VALIDA
                            179         ;;VERIFICAR SI IX TIENE EL COMPONENTE PASADO
   424B DD 7E 01      [19]  180         ld a, e_cmp(ix)
   424E A2            [ 4]  181         and d
   00F1                     182         ld__iy_ix                                                              ;;Cargar en IY lo que hay en IX
                              1    ;; LD IY, IX
                              2    ;;------------
   00F1                       3    ld__a_ixl
   424F DD 7D                 1    .dw #0x7DDD  ;; Opcode for ld a, ixl
   00F3                       4    ld__iyl_a
   4251 FD 6F                 1    .dw #0x6FFD  ;; Opcode for ld iyl, a
   00F5                       5    ld__a_ixh
   4253 DD 7C                 1    .dw #0x7CDD  ;; Opcode for ld a, ixh
   00F7                       6    ld__iyh_a
   4255 FD 67                 1    .dw #0x67FD  ;; Opcode for ld iyh, a
                              7    ;;------------
                            183 
                            184         ;;CASO: ENTIDAD IX TIENE EL COMPONENTE
   4257 20 02         [12]  185         jr nz, cumple_pairs
...
Hexadecimal [16-Bits]
                            ...
                            186 
                            187         ;;CASO: LA ENTIDAD IX NO TIENE EL COMPONENTE, BUSCA EN LA SIGUIENTE         
   4259 18 2F         [12]  188         jr continua_pairs
                            189 
                            190 
   425B                     191         cumple_pairs:
                            192            ; Significa que este elemento cumple que es colisionable
                            193            ; A partir de aqui se busca el siguiente elemento colisionable para luego ver el tipo de colision entre la parejas
   425B 01 0D 00      [10]  194             ld bc, #sizeof_e
   425E DD 09         [15]  195             add ix, bc
   4260 3A 93 42      [13]  196             ld a, (_ent_counter2)
   4263 3D            [ 4]  197             dec a
   4264                     198             second_loop_pairs:
   4264 32 7C 42      [13]  199                 ld (_ent_counter_2), a  ;;Resto de entidades a comprobar
                            200 
                            201                 ;;VERIFICAR SI EL TIPO DE LA ENTIDAD IX ES DEFAULT
   4267 DD 5E 00      [19]  202                 ld e, e_t(ix)
   426A 3A 62 41      [13]  203                 ld a, (t_default)
   426D A3            [ 4]  204                 and e
                            205 
                            206                 ;;CASO: LA ENTIDAD EN IX ES INVALIDA
   426E 20 13         [12]  207                 jr nz, invalid_entity_2_pairs
                            208 
                            209                 ;;CASO: LA ENTIDAD EN IX ES VALIDA
                            210                 ;;VERIFICAR SI IX TIENE EL COMPONENTE PASADO
   4270 DD 7E 01      [19]  211                 ld a, e_cmp(ix)
   4273 A2            [ 4]  212                 and d
                            213 
                            214                 ;;CASO: LA SEGUNDA ENTIDAD TAMBIEN TIENE EL COMPONENTE
   4274 20 02         [12]  215                 jr nz, cumple2_pairs
                            216 
                            217                 ;;CASO: LA SEGUNDA ENTIDAD NO TIENE EL COMPONENTE, BUSCA EN LA SIGUIENTE
   4276 18 03         [12]  218                 jr continua2_pairs
                            219 
   4278                     220                 cumple2_pairs:  
   4278 CD 16 40      [17]  221                     call collider_one_pair
                            222 
   427B                     223                 continua2_pairs:
                     011E   224                     _ent_counter_2 = .+1
   427B 3E 00         [ 7]  225                     ld  a, #0
   427D 3D            [ 4]  226                     dec a
   427E 28 0A         [12]  227                     jr z, continua_pairs
   4280 32 7C 42      [13]  228                     ld (_ent_counter_2), a
                            229 
   4283                     230                 invalid_entity_2_pairs:
   4283 01 0D 00      [10]  231                     ld bc, #sizeof_e
   4286 DD 09         [15]  232                     add ix, bc
   4288 18 DA         [12]  233                     jr second_loop_pairs
                            234                    
   428A                     235         continua_pairs:
   012C                     236             ld__ix_iy
                              1    ;; LD IX, IY
                              2    ;;------------
   012C                       3    ld__a_iyl
   428A FD 7D                 1    .dw #0x7DFD  ;; Opcode for ld a, iyl
...
Hexadecimal [16-Bits]
   ...
   012E                       4    ld__ixl_a
   428C DD 6F                 1    .dw #0x6FDD  ;; Opcode for ld ixl, a
   0130                       5    ld__a_iyh
   428E FD 7C                 1    .dw #0x7CFD  ;; Opcode for ld a, iyh
   0132                       6    ld__ixh_a
   4290 DD 67                 1    .dw #0x67DD  ;; Opcode for ld ixh, a
                              7    ;;------------
                     0135   237             _ent_counter2 = .+1
   4292 3E 00         [ 7]  238             ld  a, #0
   4294 3D            [ 4]  239             dec a
   4295 C8            [11]  240         ret z
                            241 
   4296 32 93 42      [13]  242         ld (_ent_counter2), a
                            243         
   4299                     244         invalid_entity_pairs:
   4299 01 0D 00      [10]  245             ld bc, #sizeof_e
   429C DD 09         [15]  246             add ix, bc
   429E 18 9F         [12]  247             jr _renloop_pairs
                            248 

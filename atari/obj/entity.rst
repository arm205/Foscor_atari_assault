...
Hexadecimal [16-Bits]
                             ...
                             11 .include "collider.h.s"
                              ...
                              3 
                              4 
   4163 00                    5 x_ban: .db 0x00
   4164 00                    6 y_ban: .db 0x00
                              7 
                              8 
                              9 
...
Hexadecimal [16-Bits]
                     ...
                     0006    13 max_entities == 6
                             14 
   4167 00                   15 _num_entities:: .db 0
   4168 6A 41                16 _last_elem_ptr:: .dw _entity_array
   416A                      17 DefineEntityArray _entity_array, max_entities
   ...
   416A 00                    1     .db 0x00 ;    type of entity default
   416B 00                    2     .db 0x00 ;      components of entity default
   000F                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   416C DE                    1     .db 0xDE ;    position x of entity
   416D AD                    2     .db 0xAD ;    position y of entity
   416E DE                    3     .db 0xDE ;    width of entity
   416F AD                    4     .db 0xAD ;    height y of entity
   4170 DE                    5     .db 0xDE ;    speed x of entity
   4171 AD                    6     .db 0xAD ;    speed x of entity
   4172 DE                    7     .db 0xDE ;    color of entity
   4173 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   4174 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   4176 00                    4     .db 0x00
   001A                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4177 00                    1     .db 0x00 ;    type of entity default
   4178 00                    2     .db 0x00 ;      components of entity default
   001C                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4179 DE                    1     .db 0xDE ;    position x of entity
   417A AD                    2     .db 0xAD ;    position y of entity
   417B DE                    3     .db 0xDE ;    width of entity
   417C AD                    4     .db 0xAD ;    height y of entity
   417D DE                    5     .db 0xDE ;    speed x of entity
   417E AD                    6     .db 0xAD ;    speed x of entity
   417F DE                    7     .db 0xDE ;    color of entity
   4180 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   4181 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   4183 00                    4     .db 0x00
   0027                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4184 00                    1     .db 0x00 ;    type of entity default
   4185 00                    2     .db 0x00 ;      components of entity default
   0029                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4186 DE                    1     .db 0xDE ;    position x of entity
   4187 AD                    2     .db 0xAD ;    position y of entity
   4188 DE                    3     .db 0xDE ;    width of entity
   4189 AD                    4     .db 0xAD ;    height y of entity
   418A DE                    5     .db 0xDE ;    speed x of entity
   418B AD                    6     .db 0xAD ;    speed x of entity
   418C DE                    7     .db 0xDE ;    color of entity
   418D AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   418E CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   4190 00                    4     .db 0x00
...
Hexadecimal [16-Bits]
   ...
   4193 DE                    1     .db 0xDE ;    position x of entity
   4194 AD                    2     .db 0xAD ;    position y of entity
   4195 DE                    3     .db 0xDE ;    width of entity
   4196 AD                    4     .db 0xAD ;    height y of entity
   4197 DE                    5     .db 0xDE ;    speed x of entity
   4198 AD                    6     .db 0xAD ;    speed x of entity
   4199 DE                    7     .db 0xDE ;    color of entity
   419A AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   419B CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   419D 00                    4     .db 0x00
   0041                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   419E 00                    1     .db 0x00 ;    type of entity default
   419F 00                    2     .db 0x00 ;      components of entity default
   0043                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41A0 DE                    1     .db 0xDE ;    position x of entity
   41A1 AD                    2     .db 0xAD ;    position y of entity
   41A2 DE                    3     .db 0xDE ;    width of entity
   41A3 AD                    4     .db 0xAD ;    height y of entity
   41A4 DE                    5     .db 0xDE ;    speed x of entity
   41A5 AD                    6     .db 0xAD ;    speed x of entity
   41A6 DE                    7     .db 0xDE ;    color of entity
   41A7 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   41A8 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   41AA 00                    4     .db 0x00
   004E                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41AB 00                    1     .db 0x00 ;    type of entity default
   41AC 00                    2     .db 0x00 ;      components of entity default
   0050                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41AD DE                    1     .db 0xDE ;    position x of entity
   41AE AD                    2     .db 0xAD ;    position y of entity
   41AF DE                    3     .db 0xDE ;    width of entity
   41B0 AD                    4     .db 0xAD ;    height y of entity
   41B1 DE                    5     .db 0xDE ;    speed x of entity
   41B2 AD                    6     .db 0xAD ;    speed x of entity
   41B3 DE                    7     .db 0xDE ;    color of entity
   41B4 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   41B5 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   41B7 00                    4     .db 0x00
                             18 
                             19 ; Input
   ...
   41B8                      22 E_M_init::
   41B8 AF            [ 4]   23     xor a
   41B9 32 67 41      [13]   24     ld (_num_entities), a
                             25 
   41BC 21 6A 41      [10]   26     ld hl, #_entity_array
   41BF 22 68 41      [16]   27     ld (_last_elem_ptr), hl
   41C2 C9            [10]   28 ret
                             29 
                             30 
                             31 ; Input
...
Hexadecimal [16-Bits]
   ...
   41C3 21 67 41      [10]   36     ld hl, #_num_entities
   41C6 34            [11]   37     inc (hl)
                             38 
                             39 ;   Increment Array end pointer to point to the next
                             40 ;   free element in the array
   41C7 2A 68 41      [16]   41     ld hl, (_last_elem_ptr)
   41CA 54            [ 4]   42     ld d, h
   41CB 5D            [ 4]   43     ld e, l
   41CC 01 0D 00      [10]   44     ld bc, #sizeof_e
   41CF 09            [11]   45     add hl, bc
   41D0 22 68 41      [16]   46     ld (_last_elem_ptr), hl
                             47 
   41D3 C9            [10]   48 ret
                             49 
   ...
   41D4                      53 E_M_create::
   41D4 E5            [11]   54     push hl
                             55     
   41D5 CD C3 41      [17]   56     call E_M_new
                             57 
   007B                      58     ld__ixh_d
   41D8 DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
   007D                      59     ld__ixl_e
   41DA DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                             60 
                             61 
   41DC E1            [10]   62     pop hl
   41DD ED B0         [21]   63     ldir
                             64 
   41DF C9            [10]   65 ret
                             66 
   41E0                      67 E_M_getEntityArray::
   41E0 DD 21 6A 41   [14]   68     ld ix, #_entity_array
   41E4 3A 67 41      [13]   69     ld a, (_num_entities)
   41E7 C9            [10]   70 ret
                             71 
                             72 
                             73 
...
Hexadecimal [16-Bits]
   ...
   41F2 7B            [ 4]   88     ld a, e
   41F3 59            [ 4]   89     ld e, c
   41F4 3A 61 41      [13]   90     ld a, (t_default)
   41F7 A3            [ 4]   91     and e
   41F8 20 3A         [12]   92     jr nz, invalid_entity
                             93 
                             94     ;; erase previous istance
                             95 ; para mover todo lo que tenga a 1 el bit de ia
   41FA DD 7E 01      [19]   96     ld a, e_cmp(ix)
   41FD A2            [ 4]   97     and d
   41FE 20 02         [12]   98     jr nz, cumple
   4200 18 2B         [12]   99     jr continua
   4202                     100     cumple:    
   4202 3A 5E 41      [13]  101         ld a, (cmp_ia)
   4205 AA            [ 4]  102         xor d
   ...
   420D 18 1E         [12]  107             jr continua
                            108 
   420F                     109         no_ia:
   420F 3A 5F 41      [13]  110             ld a, (cmp_input)
   4212 AA            [ 4]  111             xor d
   4213 28 02         [12]  112             jr z, control
   4215 18 07         [12]  113             jr mover_cosas
   4217                     114                 control:
   ...
   421E 3A 5D 41      [13]  121             ld a, (cmp_render)
   4221 AA            [ 4]  122             xor d
   4222 28 02         [12]  123             jr z, render
   4224 18 07         [12]  124             jr continua
   4226                     125                 render:
   ...
   422D 3E 00         [ 7]  135     ld  a, #0
   422F 3D            [ 4]  136     dec a
   4230 C8            [11]  137     ret z
                            138 
                            139 
                            140 
...
Hexadecimal [16-Bits]
                            ...
                            142 
   4234                     143     invalid_entity:
   4234 01 0D 00      [10]  144     ld bc, #sizeof_e
   4237 DD 09         [15]  145     add ix, bc

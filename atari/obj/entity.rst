...
Hexadecimal [16-Bits]
   ...
   4174 01                  107 cmp_render: .db 0x01
                            108 ;; 00000010 para las entidades que usen IA
   4175 02                  109 cmp_ia: .db 0x02
...
Hexadecimal [16-Bits]
   ...
   4176 04                  111 cmp_input: .db 0x04
                            112 ;;  entidades con colisiones
   4177 08                  113 cmp_collider: .db 0x08
                            114 
                            115 
                            116 ;; Tipos de las entidades
   4178 00                  117 t_default: .db 0x00
                            118 
   4179 80                  119 t_dead: .db 0x80
                            120 
                            121 
                            122 
                            123 
...
Hexadecimal [16-Bits]
                             ...
                             11 .include "collider.h.s"
                              ...
                              3 
                              4 
   417A 00                    5 x_ban: .db 0x00
   417B 00                    6 y_ban: .db 0x00
                              7 
                              8 
                              9 
   417C 00                   10 x_ban_2: .db 0x00
   417D 00                   11 y_ban_2: .db 0x00
...
Hexadecimal [16-Bits]
                     ...
                     0006    13 max_entities == 6
                             14 
   417E 00                   15 _num_entities:: .db 0
   417F 81 41                16 _last_elem_ptr:: .dw _entity_array
   4181                      17 DefineEntityArray _entity_array, max_entities
   ...
   4181 00                    1     .db 0x00 ;    type of entity default
   4182 00                    2     .db 0x00 ;      components of entity default
   000F                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4183 DE                    1     .db 0xDE ;    position x of entity
   4184 AD                    2     .db 0xAD ;    position y of entity
   4185 DE                    3     .db 0xDE ;    width of entity
   4186 AD                    4     .db 0xAD ;    height y of entity
   4187 DE                    5     .db 0xDE ;    speed x of entity
   4188 AD                    6     .db 0xAD ;    speed x of entity
   4189 DE                    7     .db 0xDE ;    color of entity
   418A AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   418B CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   418D 00                    4     .db 0x00
   001A                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   418E 00                    1     .db 0x00 ;    type of entity default
   418F 00                    2     .db 0x00 ;      components of entity default
   001C                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   4190 DE                    1     .db 0xDE ;    position x of entity
   4191 AD                    2     .db 0xAD ;    position y of entity
   4192 DE                    3     .db 0xDE ;    width of entity
   4193 AD                    4     .db 0xAD ;    height y of entity
   4194 DE                    5     .db 0xDE ;    speed x of entity
   4195 AD                    6     .db 0xAD ;    speed x of entity
   4196 DE                    7     .db 0xDE ;    color of entity
   4197 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   4198 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   419A 00                    4     .db 0x00
   0027                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   419B 00                    1     .db 0x00 ;    type of entity default
   419C 00                    2     .db 0x00 ;      components of entity default
   0029                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   419D DE                    1     .db 0xDE ;    position x of entity
   419E AD                    2     .db 0xAD ;    position y of entity
   419F DE                    3     .db 0xDE ;    width of entity
   41A0 AD                    4     .db 0xAD ;    height y of entity
   41A1 DE                    5     .db 0xDE ;    speed x of entity
   41A2 AD                    6     .db 0xAD ;    speed x of entity
   41A3 DE                    7     .db 0xDE ;    color of entity
   41A4 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   41A5 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   41A7 00                    4     .db 0x00
   0034                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41A8 00                    1     .db 0x00 ;    type of entity default
   41A9 00                    2     .db 0x00 ;      components of entity default
...
Hexadecimal [16-Bits]
   ...
   41AA DE                    1     .db 0xDE ;    position x of entity
   41AB AD                    2     .db 0xAD ;    position y of entity
   41AC DE                    3     .db 0xDE ;    width of entity
   41AD AD                    4     .db 0xAD ;    height y of entity
   41AE DE                    5     .db 0xDE ;    speed x of entity
   41AF AD                    6     .db 0xAD ;    speed x of entity
   41B0 DE                    7     .db 0xDE ;    color of entity
   41B1 AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   41B2 CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   41B4 00                    4     .db 0x00
   0041                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41B5 00                    1     .db 0x00 ;    type of entity default
   41B6 00                    2     .db 0x00 ;      components of entity default
   0043                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41B7 DE                    1     .db 0xDE ;    position x of entity
   41B8 AD                    2     .db 0xAD ;    position y of entity
   41B9 DE                    3     .db 0xDE ;    width of entity
   41BA AD                    4     .db 0xAD ;    height y of entity
   41BB DE                    5     .db 0xDE ;    speed x of entity
   41BC AD                    6     .db 0xAD ;    speed x of entity
   41BD DE                    7     .db 0xDE ;    color of entity
   41BE AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   41BF CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   41C1 00                    4     .db 0x00
   004E                       1         DefineDefaultEntity 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41C2 00                    1     .db 0x00 ;    type of entity default
   41C3 00                    2     .db 0x00 ;      components of entity default
   0050                       3     CommonDefine 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD, 0xDE, 0xAD
   41C4 DE                    1     .db 0xDE ;    position x of entity
   41C5 AD                    2     .db 0xAD ;    position y of entity
   41C6 DE                    3     .db 0xDE ;    width of entity
   41C7 AD                    4     .db 0xAD ;    height y of entity
   41C8 DE                    5     .db 0xDE ;    speed x of entity
   41C9 AD                    6     .db 0xAD ;    speed x of entity
   41CA DE                    7     .db 0xDE ;    color of entity
   41CB AD                    8     .db 0xAD;     byte that we use for setting a special behavior to an entity (asi podemos tener dos cosas del mismo tipo que se comporten distinto)
   41CC CC CC                 9     .dw 0xCCCC; last video memory value to delate later
   41CE 00                    4     .db 0x00
                             18 
                             19 ; Input
   ...
   41CF                      22 E_M_init::
   41CF AF            [ 4]   23     xor a
   41D0 32 7E 41      [13]   24     ld (_num_entities), a
                             25 
   41D3 21 81 41      [10]   26     ld hl, #_entity_array
   41D6 22 7F 41      [16]   27     ld (_last_elem_ptr), hl
   41D9 C9            [10]   28 ret
                             29 
                             30 
                             31 ; Input
...
Hexadecimal [16-Bits]
   ...
   41DA 21 7E 41      [10]   36     ld hl, #_num_entities
   41DD 34            [11]   37     inc (hl)
                             38 
                             39 ;   Increment Array end pointer to point to the next
                             40 ;   free element in the array
   41DE 2A 7F 41      [16]   41     ld hl, (_last_elem_ptr)
   41E1 54            [ 4]   42     ld d, h
   41E2 5D            [ 4]   43     ld e, l
   41E3 01 0D 00      [10]   44     ld bc, #sizeof_e
   41E6 09            [11]   45     add hl, bc
   41E7 22 7F 41      [16]   46     ld (_last_elem_ptr), hl
                             47 
   41EA C9            [10]   48 ret
                             49 
                             50 ; Input: HL; pointer to entity initializer bytes
                             51 ; Desc: 
                             52 ; Modifies: IX, HL, BC, DE
   41EB                      53 E_M_create::
   41EB E5            [11]   54     push hl
                             55     
   41EC CD DA 41      [17]   56     call E_M_new
                             57 
   007B                      58     ld__ixh_d
   41EF DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
   007D                      59     ld__ixl_e
   41F1 DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                             60 
                             61 
   41F3 E1            [10]   62     pop hl
   41F4 ED B0         [21]   63     ldir
                             64 
   41F6 C9            [10]   65 ret
                             66 
   41F7                      67 E_M_getEntityArray::
   41F7 DD 21 81 41   [14]   68     ld ix, #_entity_array
   41FB 3A 7E 41      [13]   69     ld a, (_num_entities)
   41FE C9            [10]   70 ret
                             71 
                             72 
                             73 
                             74 ;
                             75 ;Input: A type that we are looking for, D num entity
   41FF                      76 E_M_for_all_matching::
   41FF 4F            [ 4]   77     ld c, a
   4200 7A            [ 4]   78     ld a, d
   4201 51            [ 4]   79     ld d, c
                             80 
                             81     ;intercambio A y D
                             82 
   4202                      83 _renloop:
   4202 32 45 42      [13]   84     ld (_ent_counter), a
                             85 
   4205 DD 7E 00      [19]   86     ld a, e_t(ix)
...
Hexadecimal [16-Bits]
   ...
   4209 7B            [ 4]   88     ld a, e
   420A 59            [ 4]   89     ld e, c
   420B 3A 78 41      [13]   90     ld a, (t_default)
   420E A3            [ 4]   91     and e
   420F 20 3A         [12]   92     jr nz, invalid_entity
                             93 
                             94     ;; erase previous istance
                             95 ; para mover todo lo que tenga a 1 el bit de ia
   4211 DD 7E 01      [19]   96     ld a, e_cmp(ix)
   4214 A2            [ 4]   97     and d
   4215 20 02         [12]   98     jr nz, cumple
   4217 18 2B         [12]   99     jr continua
   4219                     100     cumple:    
   4219 3A 75 41      [13]  101         ld a, (cmp_ia)
   421C AA            [ 4]  102         xor d
   421D 28 02         [12]  103         jr z, con_ia
   421F 18 05         [12]  104         jr no_ia
   4221                     105         con_ia:
   4221 CD 76 43      [17]  106             call ia_update_one_entity
   4224 18 1E         [12]  107             jr continua
                            108 
   4226                     109         no_ia:
   4226 3A 76 41      [13]  110             ld a, (cmp_input)
   4229 AA            [ 4]  111             xor d
   422A 28 02         [12]  112             jr z, control
   422C 18 07         [12]  113             jr mover_cosas
   422E                     114                 control:
   422E D5            [11]  115                 push de
                            116 ;; Con esto modifico la velocidad del player dependiendo de la tecla pulsada
   422F CD C2 43      [17]  117                 call input_update_one
   4232 D1            [10]  118                 pop de
   4233 18 0F         [12]  119                 jr continua
   4235                     120         mover_cosas:
   4235 3A 74 41      [13]  121             ld a, (cmp_render)
   4238 AA            [ 4]  122             xor d
   4239 28 02         [12]  123             jr z, render
   423B 18 07         [12]  124             jr continua
   423D                     125                 render:
   ...
   4244                     132     continua:
                            133 
                     00D1   134 _ent_counter = .+1
   4244 3E 00         [ 7]  135     ld  a, #0
   4246 3D            [ 4]  136     dec a
   4247 C8            [11]  137     ret z
                            138 
                            139 
                            140 
   4248 32 45 42      [13]  141     ld (_ent_counter), a
...
Hexadecimal [16-Bits]
                            ...
                            142 
   424B                     143     invalid_entity:
   424B 01 0D 00      [10]  144     ld bc, #sizeof_e
   424E DD 09         [15]  145     add ix, bc
   4250 18 B0         [12]  146     jr _renloop
                            147 
                            148 
   4252                     149 E_M_for_all_pairs_matching::
   4252 4F            [ 4]  150     ld c, a
   4253 7A            [ 4]  151     ld a, d
   4254 51            [ 4]  152     ld d, c
                            153    ;intercambio A y D;
   4255                     154     _renloop_pairs:
   4255 32 AF 42      [13]  155         ld (_ent_counter2), a
   4258 DD 7E 00      [19]  156         ld a, e_t(ix)
   425B 4F            [ 4]  157         ld c, a
   425C 7B            [ 4]  158         ld a, e
   425D 59            [ 4]  159         ld e, c
   425E 3A 78 41      [13]  160         ld a, (t_default)
   4261 A3            [ 4]  161         and e
   4262 20 51         [12]  162         jr nz, invalid_entity_pairs
                            163        ;; erase previous istance
                            164        ; para mover todo lo que tenga a 1 el bit de ia
   4264 DD 7E 01      [19]  165         ld a, e_cmp(ix)
   4267 A2            [ 4]  166         and d
   00F4                     167         ld__iy_ix
                              1    ;; LD IY, IX
                              2    ;;------------
   00F4                       3    ld__a_ixl
   4268 DD 7D                 1    .dw #0x7DDD  ;; Opcode for ld a, ixl
   00F6                       4    ld__iyl_a
   426A FD 6F                 1    .dw #0x6FFD  ;; Opcode for ld iyl, a
   00F8                       5    ld__a_ixh
   426C DD 7C                 1    .dw #0x7CDD  ;; Opcode for ld a, ixh
   00FA                       6    ld__iyh_a
   426E FD 67                 1    .dw #0x67FD  ;; Opcode for ld iyh, a
                              7    ;;------------
   4270 20 02         [12]  168         jr nz, cumple_pairs
   4272 18 32         [12]  169         jr continua_pairs
   4274                     170         cumple_pairs:    
   ...
   4274 01 0D 00      [10]  174             ld bc, #sizeof_e
   4277 DD 09         [15]  175             add ix, bc
   4279 3A AF 42      [13]  176             ld a, (_ent_counter2)
   427C 3D            [ 4]  177             dec a
   427D                     178             second_loop_pairs:
   427D 32 98 42      [13]  179                ld (_ent_counter_2), a
   4280 DD 7E 00      [19]  180                 ld a, e_t(ix)
   4283 4F            [ 4]  181                 ld c, a
   4284 7B            [ 4]  182                 ld a, e
   4285 59            [ 4]  183                 ld e, c
   4286 3A 78 41      [13]  184                 ld a, (t_default)
   4289 A3            [ 4]  185                 and e
...
Hexadecimal [16-Bits]
   ...
   428A 20 13         [12]  186                 jr nz, invalid_entity_2_pairs
   428C DD 7E 01      [19]  187                 ld a, e_cmp(ix)
   428F A2            [ 4]  188                 and d
   4290 20 02         [12]  189                 jr nz, cumple2_pairs
   4292 18 03         [12]  190                 jr continua2_pairs
   4294                     191                   cumple2_pairs:  
   4294 CD 16 40      [17]  192                   call collider_one_pair
   4297                     193             continua2_pairs:
                     0124   194                 _ent_counter_2 = .+1
   4297 3E 00         [ 7]  195                 ld  a, #0
   4299 3D            [ 4]  196                 dec a
   429A 28 0A         [12]  197                 jr z, continua_pairs
   429C 32 98 42      [13]  198                 ld (_ent_counter_2), a
   429F                     199             invalid_entity_2_pairs:
   429F 01 0D 00      [10]  200                 ld bc, #sizeof_e
   42A2 DD 09         [15]  201                 add ix, bc
   42A4 18 D7         [12]  202                 jr second_loop_pairs
                            203                    
   42A6                     204     continua_pairs:
   0132                     205     ld__ix_iy
                              1    ;; LD IX, IY
                              2    ;;------------
   0132                       3    ld__a_iyl
   42A6 FD 7D                 1    .dw #0x7DFD  ;; Opcode for ld a, iyl
   0134                       4    ld__ixl_a
   42A8 DD 6F                 1    .dw #0x6FDD  ;; Opcode for ld ixl, a
   0136                       5    ld__a_iyh
   42AA FD 7C                 1    .dw #0x7CFD  ;; Opcode for ld a, iyh
   0138                       6    ld__ixh_a
   42AC DD 67                 1    .dw #0x67DD  ;; Opcode for ld ixh, a
                              7    ;;------------
                     013B   206     _ent_counter2 = .+1
   42AE 3E 00         [ 7]  207     ld  a, #0
   42B0 3D            [ 4]  208    dec a
   42B1 C8            [11]  209    ret z
                            210 
   42B2 32 AF 42      [13]  211    ld (_ent_counter2), a;
   42B5                     212    invalid_entity_pairs:
   42B5 01 0D 00      [10]  213    ld bc, #sizeof_e
   42B8 DD 09         [15]  214    add ix, bc
   42BA 18 99         [12]  215    jr _renloop_pairs;
                            216 

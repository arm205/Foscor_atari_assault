...
Hexadecimal [16-Bits]
   ...
   4004 01                   98 cmp_render: .db 0x01
                             99 ;; 00000010 para las entidades que usen IA
   4005 02                  100 cmp_ia: .db 0x02
                            101 ;; 00000100 para las entidades con input (player)
   4006 04                  102 cmp_input: .db 0x04
                            103 ;;  entidades con colisiones
   4007 08                  104 cmp_collider: .db 0x08
                            105 
                            106 
                            107 ;; Tipos de las entidades
   4008 00                  108 t_default: .db 0x00
                            109 
...
Hexadecimal [16-Bits]
   ...
   4012 CD 3C 42      [17]   11     call E_M_for_all_pairs_matching
                             12 
   4015 C9            [10]   13 ret
                             14 
                             15 
...
Hexadecimal [16-Bits]
   ...
   405B 47            [ 4]   88     ld b, a
   405C 3A C4 42      [13]   89     ld a, (t_player)
   405F A8            [ 4]   90     xor b
   ...
   406C 47            [ 4]   98         ld b, a
   406D 3A AA 42      [13]   99         ld a, (t_enemy)
   4070 A8            [ 4]  100         xor b
...
Hexadecimal [16-Bits]
   ...
   40D6                     192 collider_check_type_ix::
                            193 
                            194     ;;VERIFICAR SI IX ES EL JUGADOR     
   40D6 DD 46 00      [19]  195     ld b, e_t(ix)
   40D9 3A C4 42      [13]  196     ld a, (t_player)
   40DC A8            [ 4]  197     xor b
                            198 
                            199     ;;CASO: IX NO ES EL JUGADOR
   40DD 20 78         [12]  200     jr nz, no_player_2
                            201 
                            202         ;;VERIFICAR SI HAY COLISION CON IY
   40DF DD 7E 0C      [19]  203         ld a, e_col(ix)
   40E2 FD A6 00      [19]  204         and e_t(iy)
   40E5 C8            [11]  205         ret z
                            206         
                            207         ;;VERIFIFICAR SI IX COLISIONA CON UN ENEMIGO O UNA CAJA
   40E6 FD 46 00      [19]  208         ld b, e_t(iy)
   40E9 3A AA 42      [13]  209         ld a, (t_enemy)
   40EC A8            [ 4]  210         xor b
                            211 
                            212         ;;CASO: IX COLISIONA CON UNA CAJA
   40ED 20 09         [12]  213         jr nz, pl_caja_2
                            214 
                            215         ;;CASO: IX COLISIONA CON UN ENEMIGO
   40EF                     216         pl_en_2:
                            217             ;;Aqui tendriamos que matar al jugador
   40EF 3E 00         [ 7]  218             ld a, #0x00 
   40F1 DD 77 08      [19]  219             ld e_c(ix), a
   40F4 CD 31 43      [17]  220             call man_game_end
   40F7 C9            [10]  221             ret
                            222 
                            223 
                            224 
...
Hexadecimal [16-Bits]
   ...
   40F8                     225         pl_caja_2:
                            226             ;;VERIFICAR SI LA CAJA TIENE EL BEHAVIOUR
   40F8 DD 7E 09      [19]  227             ld a, e_be(ix)
   40FB EE 01         [ 7]  228             xor #1
                            229 
                            230             ;;CASO: LA CAJA NO ES ROMPIBLE
   40FD 20 0C         [12]  231             jr nz, for_x_2
                            232 
                            233             ;;CASO: LA CAJA ES ROMPIBLE
   40FF 3E 00         [ 7]  234             ld a, #0
   4101 FD 77 08      [19]  235             ld e_c(iy), a
   4104 FD 77 01      [19]  236             ld e_cmp(iy), a
   4107 DD 77 09      [19]  237             ld e_be(ix), a
   410A C9            [10]  238         ret
                            239 
                            240 
                            241 ; No tiene el behavior asi que colisiona
   410B                     242         for_x_2:
   410B DD 7E 06      [19]  243             ld a, e_vx(ix)
   410E F6 00         [ 7]  244             or #0
   4110 28 1A         [12]  245             jr z, cero_x_2
                            246 
   4112 3A 0C 40      [13]  247             ld a, (x_ban_2)
   4115 A7            [ 4]  248             and a
   4116 28 0E         [12]  249             jr z, new_x_ban_2
   4118 47            [ 4]  250                 ld b, a
   4119 DD 7E 06      [19]  251                 ld a, e_vx(ix)
   411C A8            [ 4]  252                 xor b
   411D 28 0D         [12]  253                 jr z, cero_x_2
   411F                     254                 move_x_2:
                            255                 
   411F 3E 00         [ 7]  256                     ld a, #0
   4121 32 0C 40      [13]  257                     ld (x_ban_2), a
   4124 18 0B         [12]  258                     jr for_y_2
                            259                     
                            260 
   4126                     261             new_x_ban_2:
   4126 DD 7E 06      [19]  262                 ld a, e_vx(ix)
   4129 32 0C 40      [13]  263                 ld (x_ban_2), a
                            264 
                            265 
                            266 
   412C                     267             cero_x_2:
   412C 3E 00         [ 7]  268                 ld a, #0
   412E DD 77 06      [19]  269                 ld e_vx(ix), a
   4131                     270         for_y_2:
                            271 
   4131 DD 7E 07      [19]  272             ld a, e_vy(ix)
   4134 F6 00         [ 7]  273             or #0
   4136 28 19         [12]  274             jr z, cero_y_2
                            275 
   4138 3A 0D 40      [13]  276             ld a, (y_ban_2)
   413B A7            [ 4]  277             and a
   413C 28 0D         [12]  278             jr z, new_y_ban_2
   413E 47            [ 4]  279                 ld b, a
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 93.
Hexadecimal [16-Bits]



   413F DD 7E 07      [19]  280                 ld a, e_vy(ix)
   4142 A8            [ 4]  281                 xor b
   4143 28 0C         [12]  282                 jr z, cero_y_2
   4145                     283                 move_y_2:
   4145 3E 00         [ 7]  284                     ld a, #0
   4147 32 0D 40      [13]  285                     ld (y_ban_2), a
   414A C9            [10]  286                     ret
                            287 
   414B                     288             new_y_ban_2:
   414B DD 7E 07      [19]  289                 ld a, e_vy(ix)
   414E 32 0D 40      [13]  290                 ld (y_ban_2), a
                            291 
   4151                     292             cero_y_2:
   4151 3E 00         [ 7]  293                 ld a, #0
   4153 DD 77 07      [19]  294                 ld e_vy(ix), a
   4156 C9            [10]  295                 ret
                            296 
                            297 
   4157                     298 no_player_2:  
                            299 ;   DEJO ESTO POR SI EN UN FUTURO TENEMOS OTRAS ENTIDADES QUE COLISIONEN  
                            300 ;    ld a, e_t(iy)
                            301 ;    ld b, a
                            302 ;    ld a, (t_enemy)
                            303 ;    xor b

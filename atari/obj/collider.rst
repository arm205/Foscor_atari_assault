...
Hexadecimal [16-Bits]
   ...
   4004 01                  107 cmp_render: .db 0x01
                            108 ;; 00000010 para las entidades que usen IA
   4005 02                  109 cmp_ia: .db 0x02
...
Hexadecimal [16-Bits]
   ...
   4006 04                  111 cmp_input: .db 0x04
                            112 ;;  entidades con colisiones
   4007 08                  113 cmp_collider: .db 0x08
                            114 
                            115 
                            116 ;; Tipos de las entidades
   4008 00                  117 t_default: .db 0x00
                            118 
   4009 80                  119 t_dead: .db 0x80
                            120 
                            121 
                            122 
                            123 
...
Hexadecimal [16-Bits]
                              ...
                              3 .include "collider.h.s"
                              1 .globl collider_one_pair
                              2 .globl collider_update
                              3 
                              4 
   400A 00                    5 x_ban: .db 0x00
   400B 00                    6 y_ban: .db 0x00
                              7 
                              8 
                              9 
   400C 00                   10 x_ban_2: .db 0x00
   400D 00                   11 y_ban_2: .db 0x00
...
Hexadecimal [16-Bits]
                              ...
                              2 ; GAME MANAGER
                              3 ;
                              4 .globl man_game_init
                              5 .globl man_game_render
                              6 .globl man_game_update
                              7 .globl man_game_end
...
Hexadecimal [16-Bits]
                              ...
                              6 
                              7 
   400E                       8 collider_update::
   400E 57            [ 4]    9     ld d, a
   400F 3A 07 40      [13]   10     ld a, (cmp_collider)
   4012 CD 52 42      [17]   11     call E_M_for_all_pairs_matching
                             12 
   4015 C9            [10]   13 ret
                             14 
                             15 
                             16 ;INPUT IY first entity, IX second entity
   4016                      17 collider_one_pair::
   4016 FD 7E 00      [19]   18     ld a, e_t(iy)
   4019 DD A6 0C      [19]   19     and e_col(ix)
   401C 47            [ 4]   20     ld b, a
   401D DD 7E 00      [19]   21     ld a, e_t(ix)
   4020 FD A6 0C      [19]   22     and e_col(iy)
   4023 B0            [ 4]   23     or b
   4024 28 08         [12]   24     jr z, no_colisionan
                             25 
   4026 CD 2F 40      [17]   26         call check_collision
   4029 38 03         [12]   27         jr c, no_colisionan
                             28             ;cpctm_setBorder_asm HW_WHITE
                             29 
                             30             ;call collider_check_type_iy
                             31              	;ex__hl_ix
                             32  	            ;ex__hl_iy
                             33                 ;ex__hl_ix
   402B CD D6 40      [17]   34             call collider_check_type_ix
                             35 
                             36              	;ex__hl_ix
                             37  	            ;ex__hl_iy
                             38                 ;ex__hl_ix
                             ...
                             41 
                             42 
   402E                      43 no_colisionan:
                             44 ;cpctm_setBorder_asm HW_BLUE
   402E C9            [10]   45 ret
                             46 
                             47 
   402F                      48 check_collision::
                             49 
                             50 ;COLISIONES CON EL EJE X
                             51 ; if (e_x(iy)+e_w(iy)-e_x(ix) < 0) No_col
   402F FD 7E 02      [19]   52     ld a, e_x(iy)
   4032 FD 86 04      [19]   53     add e_w(iy)
   4035 DD 96 02      [19]   54     sub e_x(ix)
   4038 D8            [11]   55     ret c
                             56 
                             57 
                             58 ; if (e_x(ix)+e_w(ix)-e_x(iy) < 0) No_col
                             59 
...
Hexadecimal [16-Bits]
   ...
   4039 DD 7E 02      [19]   60     ld a, e_x(ix)
   403C DD 86 04      [19]   61     add e_w(ix)
   403F FD 96 02      [19]   62     sub e_x(iy)
   4042 D8            [11]   63     ret c
                             64 
                             65 
                             66 
                             67 ;COLISIONES CON EL EJE Y
                             68 ; if (e_x(iy)+e_w(iy)-e_x(ix) < 0) No_col
   4043 FD 7E 03      [19]   69     ld a, e_y(iy)
   4046 FD 86 05      [19]   70     add e_h(iy)
   4049 DD 96 03      [19]   71     sub e_y(ix)
   404C D8            [11]   72     ret c
                             73 
                             74 
                             75 ; if (e_x(ix)+e_w(ix)-e_x(iy) < 0) No_col
                             76 
   404D DD 7E 03      [19]   77     ld a, e_y(ix)
   4050 DD 86 05      [19]   78     add e_h(ix)
   4053 FD 96 03      [19]   79     sub e_y(iy)
   4056 D8            [11]   80     ret c
   4057 C9            [10]   81 ret
                             82 
                             83 
                             84 
   4058                      85 collider_check_type_iy::
                             86 
   4058 FD 7E 00      [19]   87     ld a, e_t(iy)
   405B 47            [ 4]   88     ld b, a
   405C 3A E0 42      [13]   89     ld a, (t_player)
   405F A8            [ 4]   90     xor b
   4060 20 73         [12]   91     jr nz, no_player
                             92 
   4062 FD 7E 0C      [19]   93         ld a, e_col(iy)
   4065 DD A6 00      [19]   94         and e_t(ix)
   4068 C8            [11]   95         ret z
                             96 
   4069 DD 7E 00      [19]   97         ld a, e_t(ix)
   406C 47            [ 4]   98         ld b, a
   406D 3A C6 42      [13]   99         ld a, (t_enemy)
   4070 A8            [ 4]  100         xor b
   4071 20 06         [12]  101         jr nz, pl_caja
   4073                     102         pl_en:
                            103             ;; Aqui tendriamos que matar al jugador
   4073 3E 00         [ 7]  104             ld a, #0x00 
   4075 FD 77 08      [19]  105             ld e_c(iy), a
   4078 C9            [10]  106             ret
                            107 
   4079                     108         pl_caja:
                            109         ; Compruebo si tiene el behavior de romper caja
                            110 
   4079 FD 7E 09      [19]  111         ld a, e_be(iy)
   407C EE 01         [ 7]  112         xor #1
   407E 20 09         [12]  113         jr nz, for_x
                            114         ;tiene el behavior asi que la rompe
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 90.
Hexadecimal [16-Bits]



   4080 3E 00         [ 7]  115         ld a, #0
   4082 DD 77 08      [19]  116         ld e_c(ix), a
   4085 FD 77 09      [19]  117         ld e_be(iy), a
   4088 C9            [10]  118         ret
                            119 
                            120 
                            121 ; No tiene el behavior asi que colisiona
   4089                     122         for_x:
   4089 FD 7E 06      [19]  123             ld a, e_vx(iy)
   408C F6 00         [ 7]  124             or #0
   408E 28 1A         [12]  125             jr z, cero_x
                            126 
   4090 3A 0A 40      [13]  127             ld a, (x_ban)
   4093 A7            [ 4]  128             and a
   4094 28 0E         [12]  129             jr z, new_x_ban
   4096 47            [ 4]  130                 ld b, a
   4097 FD 7E 06      [19]  131                 ld a, e_vx(iy)
   409A A8            [ 4]  132                 xor b
   409B 28 0D         [12]  133                 jr z, cero_x
   409D                     134                 move_x:
                            135                 
   409D 3E 00         [ 7]  136                     ld a, #0
   409F 32 0A 40      [13]  137                     ld (x_ban), a
   40A2 18 0B         [12]  138                     jr for_y
                            139                     
                            140 
   40A4                     141             new_x_ban:
   40A4 FD 7E 06      [19]  142                 ld a, e_vx(iy)
   40A7 32 0A 40      [13]  143                 ld (x_ban), a
                            144 
                            145 
                            146 
   40AA                     147             cero_x:
   40AA 3E 00         [ 7]  148                 ld a, #0
   40AC FD 77 06      [19]  149                 ld e_vx(iy), a
   40AF                     150         for_y:
                            151 
   40AF FD 7E 07      [19]  152             ld a, e_vy(iy)
   40B2 F6 00         [ 7]  153             or #0
   40B4 28 19         [12]  154             jr z, cero_y
                            155 
   40B6 3A 0B 40      [13]  156             ld a, (y_ban)
   40B9 A7            [ 4]  157             and a
   40BA 28 0D         [12]  158             jr z, new_y_ban
   40BC 47            [ 4]  159                 ld b, a
   40BD FD 7E 07      [19]  160                 ld a, e_vy(iy)
   40C0 A8            [ 4]  161                 xor b
   40C1 28 0C         [12]  162                 jr z, cero_y
   40C3                     163                 move_y:
   40C3 3E 00         [ 7]  164                     ld a, #0
   40C5 32 0B 40      [13]  165                     ld (y_ban), a
   40C8 C9            [10]  166                     ret
                            167 
   40C9                     168             new_y_ban:
   40C9 FD 7E 07      [19]  169                 ld a, e_vy(iy)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 91.
Hexadecimal [16-Bits]



   40CC 32 0B 40      [13]  170                 ld (y_ban), a
                            171 
   40CF                     172             cero_y:
   40CF 3E 00         [ 7]  173                 ld a, #0
   40D1 FD 77 07      [19]  174                 ld e_vy(iy), a
   40D4 C9            [10]  175                 ret
                            176 
                            177 
   40D5                     178 no_player:  
                            179 ;   DEJO ESTO POR SI EN UN FUTURO TENEMOS OTRAS ENTIDADES QUE COLISIONEN  
                            180 ;    ld a, e_t(iy)
                            181 ;    ld b, a
                            182 ;    ld a, (t_enemy)
                            183 ;    xor b
                            ...
                            185 
                            186 ;no_enemy:   
   40D5                     187 pair_not_col:
                            188 
   40D5 C9            [10]  189 ret
                            190 
                            191 
   40D6                     192 collider_check_type_ix::
                            193 
   40D6 DD 7E 00      [19]  194     ld a, e_t(ix)
   40D9 47            [ 4]  195     ld b, a
   40DA 3A E0 42      [13]  196     ld a, (t_player)
   40DD A8            [ 4]  197     xor b
   40DE C0            [11]  198     ret nz
                            199 
   40DF DD 7E 0C      [19]  200         ld a, e_col(ix)
   40E2 FD A6 00      [19]  201         and e_t(iy)
   40E5 C8            [11]  202         ret z
                            203 
   40E6 FD 7E 00      [19]  204         ld a, e_t(iy)
   40E9 47            [ 4]  205         ld b, a
   40EA 3A C6 42      [13]  206         ld a, (t_enemy)
   40ED A8            [ 4]  207         xor b
   40EE 20 21         [12]  208         jr nz, pl_caja_2
   40F0                     209         pl_en_2:
                            210 
   40F0 DD 7E 09      [19]  211             ld a, e_be(ix)
   40F3 EE 01         [ 7]  212             xor #1
   40F5 20 11         [12]  213             jr nz, en_mata
                            214             ;tiene el behavior asi que la rompe
   40F7 FD 7E 09      [19]  215             ld a, e_be(iy)
   40FA F6 00         [ 7]  216             or  #0x0
   40FC 20 05         [12]  217             jr nz, reiniciar_der
                            218 
   40FE                     219             reiniciar_izq:
   40FE FD 36 02 00   [19]  220             ld e_x(iy), #0
                            221             ;;ld e_be(ix), #0
   4102 C9            [10]  222             ret
                            223 
   4103                     224             reiniciar_der:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 92.
Hexadecimal [16-Bits]



   4103 FD 36 02 46   [19]  225             ld e_x(iy), #0x46
                            226             ;;ld e_be(ix), #0
   4107 C9            [10]  227             ret 
                            228 
                            229             ;; Aqui tendriamos que matar al jugador
   4108                     230             en_mata:
                            231 
   4108 3E 00         [ 7]  232             ld a, #0x00 
   410A DD 77 08      [19]  233             ld e_c(ix), a
   410D CD 4D 43      [17]  234             call man_game_end
   4110 C9            [10]  235             ret
                            236 
                            237 
                            238 
                            ...
                            240 
   4111                     241         pl_caja_2:
                            242         ; Compruebo si tiene el behavior de romper caja
                            243 
   4111 DD 7E 09      [19]  244         ld a, e_be(ix)
   4114 EE 01         [ 7]  245         xor #1
   4116 20 09         [12]  246         jr nz, for_x_2
                            247         ;tiene el behavior asi que la rompe
   4118 3E 00         [ 7]  248         ld a, #0
   411A FD 77 08      [19]  249         ld e_c(iy), a
   411D DD 77 09      [19]  250         ld e_be(ix), a
   4120 C9            [10]  251         ret
                            252 
                            253 
                            254 ; No tiene el behavior asi que colisiona
   4121                     255         for_x_2:
   4121 DD 7E 06      [19]  256             ld a, e_vx(ix)
   4124 F6 00         [ 7]  257             or #0
   4126 28 1A         [12]  258             jr z, cero_x_2
                            259 
   4128 3A 0C 40      [13]  260             ld a, (x_ban_2)
   412B A7            [ 4]  261             and a
   412C 28 0E         [12]  262             jr z, new_x_ban_2
   412E 47            [ 4]  263                 ld b, a
   412F DD 7E 06      [19]  264                 ld a, e_vx(ix)
   4132 A8            [ 4]  265                 xor b
   4133 28 0D         [12]  266                 jr z, cero_x_2
   4135                     267                 move_x_2:
                            268                 
   4135 3E 00         [ 7]  269                     ld a, #0
   4137 32 0C 40      [13]  270                     ld (x_ban_2), a
   413A 18 0B         [12]  271                     jr for_y_2
                            272                     
                            273 
   413C                     274             new_x_ban_2:
   413C DD 7E 06      [19]  275                 ld a, e_vx(ix)
   413F 32 0C 40      [13]  276                 ld (x_ban_2), a
                            277 
                            278 
                            279 
...
Hexadecimal [16-Bits]
   ...
   4142                     280             cero_x_2:
   4142 3E 00         [ 7]  281                 ld a, #0
   4144 DD 77 06      [19]  282                 ld e_vx(ix), a
   4147                     283         for_y_2:
                            284 
   4147 DD 7E 07      [19]  285             ld a, e_vy(ix)
   414A F6 00         [ 7]  286             or #0
   414C 28 19         [12]  287             jr z, cero_y_2
                            288 
   414E 3A 0D 40      [13]  289             ld a, (y_ban_2)
   4151 A7            [ 4]  290             and a
   4152 28 0D         [12]  291             jr z, new_y_ban_2
   4154 47            [ 4]  292                 ld b, a
   4155 DD 7E 07      [19]  293                 ld a, e_vy(ix)
   4158 A8            [ 4]  294                 xor b
   4159 28 0C         [12]  295                 jr z, cero_y_2
   415B                     296                 move_y_2:
   415B 3E 00         [ 7]  297                     ld a, #0
   415D 32 0D 40      [13]  298                     ld (y_ban_2), a
   4160 C9            [10]  299                     ret
                            300 
   4161                     301             new_y_ban_2:
   4161 DD 7E 07      [19]  302                 ld a, e_vy(ix)
   4164 32 0D 40      [13]  303                 ld (y_ban_2), a
                            304 
   4167                     305             cero_y_2:
   4167 3E 00         [ 7]  306                 ld a, #0
   4169 DD 77 07      [19]  307                 ld e_vy(ix), a
   416C C9            [10]  308                 ret
                            309 
                            310 
   416D                     311 no_player_2:  
                            312 ;   DEJO ESTO POR SI EN UN FUTURO TENEMOS OTRAS ENTIDADES QUE COLISIONEN  
                            313 ;    ld a, e_t(iy)
                            314 ;    ld b, a
                            315 ;    ld a, (t_enemy)
                            316 ;    xor b

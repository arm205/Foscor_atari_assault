...
Hexadecimal [16-Bits]
   ...
   4012 CD 3B 42      [17]   11     call E_M_for_all_pairs_matching
                             12 
   4015 C9            [10]   13 ret
                             14 
                             15 
...
Hexadecimal [16-Bits]
   ...
   405B 47            [ 4]   88     ld b, a
   405C 3A C9 42      [13]   89     ld a, (t_player)
   405F A8            [ 4]   90     xor b
   ...
   406C 47            [ 4]   98         ld b, a
   406D 3A AF 42      [13]   99         ld a, (t_enemy)
   4070 A8            [ 4]  100         xor b
...
Hexadecimal [16-Bits]
   ...
   40DA 3A C9 42      [13]  196     ld a, (t_player)
   40DD A8            [ 4]  197     xor b
   40DE 20 76         [12]  198     jr nz, no_player_2
                            199 
   40E0 DD 7E 0C      [19]  200         ld a, e_col(ix)
   40E3 FD A6 00      [19]  201         and e_t(iy)
   40E6 C8            [11]  202         ret z
                            203 
   40E7 FD 7E 00      [19]  204         ld a, e_t(iy)
   40EA 47            [ 4]  205         ld b, a
   40EB 3A AF 42      [13]  206         ld a, (t_enemy)
   40EE A8            [ 4]  207         xor b
   ...
   40F6 CD 36 43      [17]  213             call man_game_end
   40F9 C9            [10]  214             ret
                            215 
                            216 
                            217 
                            ...
                            219 
   40FA                     220         pl_caja_2:
                            221         ; Compruebo si tiene el behavior de romper caja
                            222 
   40FA DD 7E 09      [19]  223         ld a, e_be(ix)
   40FD EE 01         [ 7]  224         xor #1
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 92.
Hexadecimal [16-Bits]



   40FF 20 09         [12]  225         jr nz, for_x_2
                            226         ;tiene el behavior asi que la rompe
   4101 3E 00         [ 7]  227         ld a, #0
   4103 FD 77 08      [19]  228         ld e_c(iy), a
   4106 DD 77 09      [19]  229         ld e_be(ix), a
   4109 C9            [10]  230         ret
                            231 
                            232 
                            233 ; No tiene el behavior asi que colisiona
   410A                     234         for_x_2:
   410A DD 7E 06      [19]  235             ld a, e_vx(ix)
   410D F6 00         [ 7]  236             or #0
   410F 28 1A         [12]  237             jr z, cero_x_2
                            238 
   4111 3A 0C 40      [13]  239             ld a, (x_ban_2)
   4114 A7            [ 4]  240             and a
   4115 28 0E         [12]  241             jr z, new_x_ban_2
   4117 47            [ 4]  242                 ld b, a
   4118 DD 7E 06      [19]  243                 ld a, e_vx(ix)
   411B A8            [ 4]  244                 xor b
   411C 28 0D         [12]  245                 jr z, cero_x_2
   411E                     246                 move_x_2:
                            247                 
   411E 3E 00         [ 7]  248                     ld a, #0
   4120 32 0C 40      [13]  249                     ld (x_ban_2), a
   4123 18 0B         [12]  250                     jr for_y_2
                            251                     
                            252 
   4125                     253             new_x_ban_2:
   4125 DD 7E 06      [19]  254                 ld a, e_vx(ix)
   4128 32 0C 40      [13]  255                 ld (x_ban_2), a
                            256 
                            257 
                            258 
   412B                     259             cero_x_2:
   412B 3E 00         [ 7]  260                 ld a, #0
   412D DD 77 06      [19]  261                 ld e_vx(ix), a
   4130                     262         for_y_2:
                            263 
   4130 DD 7E 07      [19]  264             ld a, e_vy(ix)
   4133 F6 00         [ 7]  265             or #0
   4135 28 19         [12]  266             jr z, cero_y_2
                            267 
   4137 3A 0D 40      [13]  268             ld a, (y_ban_2)
   413A A7            [ 4]  269             and a
   413B 28 0D         [12]  270             jr z, new_y_ban_2
   413D 47            [ 4]  271                 ld b, a
   413E DD 7E 07      [19]  272                 ld a, e_vy(ix)
   4141 A8            [ 4]  273                 xor b
   4142 28 0C         [12]  274                 jr z, cero_y_2
   4144                     275                 move_y_2:
   4144 3E 00         [ 7]  276                     ld a, #0
   4146 32 0D 40      [13]  277                     ld (y_ban_2), a
   4149 C9            [10]  278                     ret
                            279 
...
Hexadecimal [16-Bits]
   ...
   414A                     280             new_y_ban_2:
   414A DD 7E 07      [19]  281                 ld a, e_vy(ix)
   414D 32 0D 40      [13]  282                 ld (y_ban_2), a
                            283 
   4150                     284             cero_y_2:
   4150 3E 00         [ 7]  285                 ld a, #0
   4152 DD 77 07      [19]  286                 ld e_vy(ix), a
   4155 C9            [10]  287                 ret
                            288 
                            289 
   4156                     290 no_player_2:  
                            291 ;   DEJO ESTO POR SI EN UN FUTURO TENEMOS OTRAS ENTIDADES QUE COLISIONEN  
                            292 ;    ld a, e_t(iy)
                            293 ;    ld b, a
                            294 ;    ld a, (t_enemy)
                            295 ;    xor b
